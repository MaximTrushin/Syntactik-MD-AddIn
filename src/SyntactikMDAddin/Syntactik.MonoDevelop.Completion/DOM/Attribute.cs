...
namespace Syntactik.MonoDevelop.Completion.DOM
{
    class Attribute : Syntactik.DOM.Mapped.Attribute, ICompletionNode
    {
        ...
        internal Attribute(ITextSource input, DelimiterEnum delimiter = DelimiterEnum.None, Interval nameInterval = null, Interval valueInterval = null, Interval delimiterInterval = null,
