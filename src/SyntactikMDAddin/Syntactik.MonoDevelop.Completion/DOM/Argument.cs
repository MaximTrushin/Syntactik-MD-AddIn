...
namespace Syntactik.MonoDevelop.Completion.DOM
{
    class Argument : Syntactik.DOM.Mapped.Argument, ICompletionNode
    {
        ...
        internal Argument(ITextSource input, AssignmentEnum assignment = AssignmentEnum.None, Interval nameInterval = null, Interval valueInterval = null, Interval assignmentInterval = null,
