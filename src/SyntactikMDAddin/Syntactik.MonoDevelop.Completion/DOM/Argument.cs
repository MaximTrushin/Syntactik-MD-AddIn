...
namespace Syntactik.MonoDevelop.Completion.DOM
{
    class Argument : Syntactik.DOM.Mapped.Argument, ICompletionNode
    {
        ...
        internal Argument(ITextSource input, DelimiterEnum delimiter = DelimiterEnum.None, Interval nameInterval = null, Interval valueInterval = null, Interval delimiterInterval = null,
