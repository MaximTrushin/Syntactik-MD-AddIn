...
namespace Syntactik.MonoDevelop.Completion.DOM
{
    class AliasDefinition: Syntactik.DOM.Mapped.AliasDefinition, ICompletionNode
    {
        ...
        internal AliasDefinition(ITextSource input, AssignmentEnum assignment = AssignmentEnum.None, Interval nameInterval = null, Interval valueInterval = null, Interval assignmentInterval = null,
