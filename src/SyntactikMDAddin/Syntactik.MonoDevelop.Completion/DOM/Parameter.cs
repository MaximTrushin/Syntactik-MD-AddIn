...
namespace Syntactik.MonoDevelop.Completion.DOM
{
    class Parameter : Syntactik.DOM.Mapped.Parameter, ICompletionNode
    {
        ...
        internal Parameter(ITextSource input, AssignmentEnum assignment = AssignmentEnum.None, Interval nameInterval = null, Interval valueInterval = null, Interval assignmentInterval = null,
