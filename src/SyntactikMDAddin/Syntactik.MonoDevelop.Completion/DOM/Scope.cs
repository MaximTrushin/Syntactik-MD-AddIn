...
namespace Syntactik.MonoDevelop.Completion.DOM
{
    class Scope : Syntactik.DOM.Mapped.Element, ICompletionNode
    {
        ...
        internal Scope(ITextSource input, DelimiterEnum delimiter = DelimiterEnum.None, Interval nameInterval = null, Interval valueInterval = null, Interval delimiterInterval = null,
